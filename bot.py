...
BOT_TOKEN = os.environ['TELEGRAM_BOT_TOKEN']  # Get token from environment variable
...
(SELECTING_ACTION, AWAIT_LINK, AWAIT_QUANTITY, AWAIT_ORDER_ID, AWAIT_SUPPORT_MESSAGE,
 AWAIT_DEPOSIT_TXN_ID, AWAIT_DEPOSIT_AMOUNT) = range(7)
...
def is_user_banned(user_id):
    ...
    return user_data and user_data[5]  # banned field

def check_membership(update: Update, context: CallbackContext) -> bool:
    # Implement actual channel membership check here
...
def my_account(update: Update, context: CallbackContext) -> int:
    ...
    if not user_data:
        update.message.reply_text("❌ Account not found. Please use /start to create an account.")
        return SELECTING_ACTION
        
    balance = user_data[1]
    total_orders = user_data[2] or 0
...
def statistics(update: Update, context: CallbackContext) -> int:
    ...
    c.execute("SELECT SUM(orders_value) FROM users")
    total_orders_value = c.fetchone()[0] or 0
    ...
    update.message.reply_photo(
        photo=f"https://quickchart.io/chart?c={{type:'bar',data:{{labels:['Users','Orders'],datasets:[{{label:'Count',data:[{total_users},{total_orders_value}]}}]}}}}",
        caption=stats_text,
        parse_mode='HTML'
    )
    return SELECTING_ACTION
...
def deposit(update: Update, context: CallbackContext) -> int:
    text = (
        ...
        f"<b>UPI ID:</b> <code>7908817900@ibl</code> (Tap to copy)\n"
...
def handle_service_selection(update: Update, context: CallbackContext) -> int:
    service_map = {
        ...
        "Instagram View ❤️‍🔥": {"price": 0.0008, "min_order": 10000, "service_id": "8032", "api_key": "d20b403e347a8028612ac1994882edfd5e5d9615", "api_base": "smm-jupiter.com", "unit": 1, "desc": "<b>🔰 Name: Instagram Reel Views 🥳\n\n💸 Price: ₹0.0008 per view\n🔰 Min Order: 10,000 Views</b>"},
        "Instagram Like ♥️": {"price": 0.005, "min_order": 1000, "service_id": "2849", "api_key": "6a37fe62a9cf761f5d53b82f5156894558e06043", "api_base": "mysmmapi.com", "unit": 1, "desc": "<b>🔰 Name: Instagram Post Likes 🔥\n\n💸 Price: ₹0.005 per like\n🔰 Min Order: 1000 Likes</b>"},
        "Insta Story View ❄️": {"price": 0.01, "min_order": 1000, "service_id": "2579", "api_key": "6a37fe62a9cf761f5d53b82f5156894558e06043", "api_base": "mysmmapi.com", "unit": 1, "desc": "<b>🔰 Name: Instagram Story Views ❤️‍🔥\n\n💸 Price: ₹0.01 per view\n🔰 Min Order: 1000 Views</b>"},
        "Story View's ind 🇮🇳": {"price": 0.013, "min_order": 1000, "service_id": "2841", "api_key": "6a37fe62a9cf761f5d53b82f5156894558e06043", "api_base": "mysmmapi.com", "unit": 1, "desc": "<b>🔰 Name: Story Views IND 🇮🇳\n\n💸 Price: ₹0.013 per view\n🔰 Min Order: 1000 Views</b>"},
        "Views Ultra Fast ⚡": {"price": 0.0008, "min_order": 10000, "service_id": "8033", "api_key": "d20b403e347a8028612ac1994882edfd5e5d9615", "api_base": "smm-jupiter.com", "unit": 1, "desc": "<b>⚡ Service: Instagram View Ultra Fast ⚡\n\n💸 Price: ₹0.0008 per view\n🔥 Super Speed Delivery!</b>"},
        
        # YouTube
        "YT Subscribe ❤️‍🔥": {"price": 0.035, "min_order": 1000, "service_id": "3942", "api_key": "6a37fe62a9cf761f5d53b82f5156894558e06043", "api_base": "mysmmapi.com", "unit": 1, "desc": "<b>📦 Service: YouTube Subscribe ❤️‍🔥\n\n💸 Price: ₹0.035 per subscriber\n🔰 Min Order: 1000\n💧 Drop Rate: 100% Drop (No Refill)</b>"},
        "YT Like 💖": {"price": 0.008, "min_order": 1000, "service_id": "4283", "api_key": "6a37fe62a9cf761f5d53b82f5156894558e06043", "api_base": "mysmmapi.com", "unit": 1, "desc": "<b>📦 Service: YouTube Likes 💖\n\n💸 Price: ₹0.008 per like\n🔰 Min Order: 1000\n💧 Drop Rate: Can be high (No Refill)</b>"},

        # Telegram
        "TG Subscribe ❄️": {"price": 0.01, "min_order": 1000, "service_id": "4347", "api_key": "6a37fe62a9cf761f5d53b82f5156894558e06043", "api_base": "mysmmapi.com", "unit": 1, "desc": "<b>📦 Service: TG Subscribe ❄️\n\n💸 Price: ₹0.01 per subscriber\n🔰 Min Order: 1000\n💧 Drop Rate: 100% Possible</b>"},
        "TG Like => ❤️": {"price": 0.008, "min_order": 1000, "service_id": "2642", "api_key": "6a37fe62a9cf761f5d53b82f5156894558e06043", "api_base": "mysmmapi.com", "unit": 1, "desc": "<b>📦 Service: Telegram Post Likes ❤️\n\n💸 Price: ₹0.008 per like\n🔰 Min Order: 1000</b>"},

        # Facebook
        "Fb Followers 🚀": {"price": 0.15, "min_order": 100, "service_id": "4253", "api_key": "6a37fe62a9cf761f5d53b82f5156894558e06043", "api_base": "mysmmapi.com", "unit": 1, "desc": "<b>📦 Service: Facebook Followers 📘\n\n💸 Price: ₹0.15 per follower\n🔰 Min Order: 100\n🚀 Speed: 100K/Day</b>"},
        "Reel Views 🍁": {"price": 0.001, "min_order": 10000, "service_id": "4468", "api_key": "d20b403e347a8028612ac1994882edfd5e5d9615", "api_base": "smm-jupiter.com", "unit": 1, "desc": "<b>📦 Service: FB Reel Views 🍁\n\n💸 Price: ₹0.001 per view\n🔰 Min Order: 10,000\n🚀 Speed: 200K/Day</b>"},
    }
    ...
    # Handle sub-menus
    if selected_service_name == '🚀 Instagram':
        keyboard = ReplyKeyboardMarkup([
            ["Followers NonDrop", "Followers ind 🇮🇳"],
            ["Followers Fast ⚡", "Fast Cheap Followers ⭐"],
            ["Instagram View ❤️‍🔥", "Instagram Like ♥️"],
            ["Insta Story View ❄️", "Story View's ind 🇮🇳"],
            ["Views Ultra Fast ⚡"],
            ["🔙 Order Menu"]
        ], resize_keyboard=True)
        update.message.reply_text("<b>Welcome to Instagram Services ❤️‍🔥</b>", reply_markup=keyboard, parse_mode='HTML')
    elif selected_service_name == '🎬 YouTube':
        keyboard = ReplyKeyboardMarkup([
            ["YT Subscribe ❤️‍🔥", "YT Like 💖"],
            ["🔙 Order Menu"]
        ], resize_keyboard=True)
        update.message.reply_text("<b>📺 Welcome to YouTube Services</b>", reply_markup=keyboard, parse_mode='HTML')
    elif selected_service_name == '✈️ Telegram':
        keyboard = ReplyKeyboardMarkup([
            ["TG Subscribe ❄️", "TG Like => ❤️"],
            ["🔙 Order Menu"]
        ], resize_keyboard=True)
        update.message.reply_text("<b>📡 Welcome to Telegram Services</b>", reply_markup=keyboard, parse_mode='HTML')
    elif selected_service_name == '📘 Facebook':
        keyboard = ReplyKeyboardMarkup([
...
def await_link(update: Update, context: CallbackContext) -> int:
    ...
    quantity_text = (
        ...
        f"<b>Price per unit:</b> ₹{service['price']:.4f}"
    )
...
def await_quantity(update: Update, context: CallbackContext) -> int:
    try:
        ...
        if api_response and api_response.get("order"):
            ...
            conn = get_db_connection()
            c = conn.cursor()
            c.execute("UPDATE users SET orders = orders + 1, orders_value = orders_value + ? WHERE id = ?", 
                     (cost, user_id))
            c.execute("INSERT INTO orders (user_id, service, quantity, amount) VALUES (?, ?, ?, ?)",
                     (user_id, service['name'], quantity, cost))
            conn.commit()
            conn.close()
            ...
            error_msg = api_response.get('error', 'Unknown API Error') if api_response else 'API request failed'
            update.message.reply_text(f"❌ Failed to place order.\n\n<b>Error:</b> {error_msg}", parse_mode='HTML')
...
def admin_panel(update: Update, context: CallbackContext):
    ...
    update.message.reply_text("Welcome to the Admin Panel. Use the commands to manage the bot.")
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            SELECTING_ACTION: [
                ...
                MessageHandler(Filters.regex('^🛍 Order Now$'), order_now),
                MessageHandler(Filters.regex('^🚀 Instagram$|^🎬 YouTube$|^✈️ Telegram$|^📘 Facebook$|^Followers NonDrop$|^Followers ind 🇮🇳$|^Followers Fast ⚡$|^Fast Cheap Followers ⭐$|^Instagram View ❤️‍🔥$|^Instagram Like ♥️$|^Insta Story View ❄️$|^Story View\'s ind 🇮🇳$|^Views Ultra Fast ⚡$|^YT Subscribe ❤️‍🔥$|^YT Like 💖$|^TG Subscribe ❄️$|^TG Like => ❤️$|^Fb Followers 🚀$|^Reel Views 🍁$|^🔙 Order Menu$'), handle_service_selection),
